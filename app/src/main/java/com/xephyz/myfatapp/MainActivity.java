...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    Button butMain, butResetTime, butLinkifyTxt, butUrlOk;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        butResetTime = findViewById(R.id.butResetTime);
        butLinkifyTxt = findViewById(R.id.butLinkify);
        butUrlOk = findViewById(R.id.butUrlOk);

        // ImageViews
        imgWelcomeIcon = findViewById(R.id.imgWelcomeIcon);
